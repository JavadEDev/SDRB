  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        {/* Title */}
        <h1 className="text-4xl font-bold text-[var(--text)] mb-2">Sign In</h1>
        ...
        <div className="flex gap-4 mb-6">
          ...
          >
            ...
            <span className="text-sm font-medium text-[var(--text)]">Sign in with Google</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="text-sm font-medium text-[var(--text)]">Sign in with Facebook</span>
          </button>
        </div>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 text-[var(--action-primary-bg)] border-[var(--input-border)] rounded focus:ring-[var(--input-focus-border)]"
              />
              <span className="text-sm text-[var(--text)]">Keep me logged in</span>
            </label>
            <Link
              href="/forgot-password"
              className="text-sm text-[var(--action-primary-bg)] hover:opacity-80 hover:underline"
            >
              Forgot password?
            </Link>
        </div>
        ...
        Don&apos;t have an account?{" "}
          <Link className="text-[var(--action-primary-bg)] hover:opacity-80 hover:underline font-medium" href="/signup">
            Sign Up
        </Link>
      </p>
      </div>
